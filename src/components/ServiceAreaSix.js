          ...
          <div className='row'>
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-service-inner style-3'>
                ...
                <div className='details'>
                  <h5>
                    <a href='service-details.html'>Data Encryption</a>
                  </h5>
                  <p className='mb-0'>
                    You can access SaaS applications through a web browser or
                    mobile app, as long as you have an internet connection
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-service-inner style-3'>
                ...
                <div className='details'>
                  <h5>
                    <a href='service-details.html'>Malware Removal</a>
                  </h5>
                  <p className='mb-0'>
                    You can access SaaS applications through a web browser or
                    mobile app, as long as you have an internet connection
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-service-inner style-3'>
                ...
                <div className='details'>
                  <h5>
                    <a href='service-details.html'>Web Security</a>
                  </h5>
                  <p className='mb-0'>
                    You can access SaaS applications through a web browser or
                    mobile app, as long as you have an internet connection
            ...
            <div className='col-lg-4 col-md-6'>
              <div className='single-service-inner style-3'>
                ...
                <div className='details'>
                  <h5>
                    <a href='service-details.html'>Email Security</a>
                  </h5>
                  <p className='mb-0'>
                    You can access SaaS applications through a web browser or
                    mobile app, as long as you have an internet connection
